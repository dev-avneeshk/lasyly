...
export const COMPARISONS: ComparisonData[] = [
  {
    ...
    features: [
      ...
      { feature: "Creator rooms (where available)", lasyly: true, competitor: false },
  ...
  },
  {
    ...
    switchReasons: [
      ...
      "Creator rooms let you share your analysis and grow an audience (where available)",
    ],
    features: [
      { feature: "Player prop hit rates", lasyly: true, competitor: true },
    ...
    lasylyBestFor: "Fans who want the same analytics (and more) without a subscription — plus community, live scores, and creator rooms.",
  ...
  },
  {
    ...
    heroSubheadline: "Action Network is a media company. Lasyly is a research platform built for sports fans.",
    ...
    lasylyBestFor: "Fans who want free, data-driven prop analytics with community features and don't need odds comparison or expert articles.",
  ...
  },
  {
    ...
    lasylyBestFor: "Fans who research individual players, want community insights, and prefer a free all-in-one platform over expensive specialized tools.",
  ...
  },
  {
    ...
    switchReasons: [
      ...
      "Creator rooms let you share your track record and grow an audience (where available)",
    ],
    features: [
