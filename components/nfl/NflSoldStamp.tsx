 ...
 * It slams down like an ink stamp over the card, which blurs behind it. Render
 * this as a child of a `relative` container wrapping the NflPlayerCard.
 *
 * Sibling of the NBA arena SoldStamp; kept in the nfl namespace so the two
 * products stay independently themeable.
 */
export function NflSoldStamp({
  name,
  winnerLabel,
  price,
}: {
