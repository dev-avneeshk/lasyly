  ...
  return (
    <div>
      <p className="text-[10px] font-semibold uppercase tracking-[0.08em] text-white/25 mb-3 flex items-center gap-1.5">
        ...
        {bet?.pinned ? "Pinned Prediction" : "Top Prediction"}
      </p>
      ...
      {!loaded ? (
        ...
        <div className="rounded-xl border border-dashed border-white/[0.08] px-4 py-5 text-center">
          <p className="text-[12px] text-white/35">No prediction pinned yet</p>
          <p className="text-[11px] text-white/20 mt-0.5">Share a prediction to feature it here</p>
        </div>
      ) : (
