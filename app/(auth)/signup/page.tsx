  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-[var(--color-text-muted)]">Join the largest social platform for sports bettors.</p>
      </div>
      ...
      <div className="mb-6 p-4 rounded-xl border border-white/10 bg-white/5 flex items-start gap-3">
        ...
        <p className="text-sm text-[var(--color-text-muted)]">
          Email sign-up is not available right now. Use Google or continue as a guest.
        </p>
      </div>
      ...
      <div className="mt-8 text-center text-sm text-[var(--color-text-primary)]">
        ...
        <Link href="/login" className="text-[var(--color-lime)] font-semibold hover:underline">
          Sign in
        </Link>
      </div>
    </div>
