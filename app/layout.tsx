...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    locale: "en_US",
    url: process.env.NEXT_PUBLIC_SITE_URL || "https://lasyly.com",
  },
  twitter: {
  ...
  alternates: {
    canonical: process.env.NEXT_PUBLIC_SITE_URL || "https://lasyly.com",
    types: {
      "application/rss+xml": `${process.env.NEXT_PUBLIC_SITE_URL || "https://lasyly.com"}/blog/feed.xml`,
    },
  },
};
      ...
      <body className="min-h-full h-full bg-[var(--color-background)] text-[var(--color-text-primary)]">
        ...
        <JsonLd data={{
          ...
          "potentialAction": {
            ...
            "target": {
              "@type": "EntryPoint",
              "urlTemplate": `${process.env.NEXT_PUBLIC_SITE_URL || "https://lasyly.com"}/analysis?search={search_term_string}`,
            },
        ...
        <JsonLd data={{
          ...
          "itemListElement": [
            ...
            },
            {
              ...
              "position": 1,
              "name": "Prop Analytics",
              "url": `${process.env.NEXT_PUBLIC_SITE_URL || "https://lasyly.com"}/analysis`,
            ...
            },
            {
              ...
              "position": 2,
              "name": "Live Scores",
              "url": `${process.env.NEXT_PUBLIC_SITE_URL || "https://lasyly.com"}/scores`,
            ...
            },
            {
              ...
              "position": 3,
              "name": "Betting Rooms",
              "url": `${process.env.NEXT_PUBLIC_SITE_URL || "https://lasyly.com"}/rooms`,
            ...
            },
            {
              ...
              "position": 4,
              "name": "Sports News",
              "url": `${process.env.NEXT_PUBLIC_SITE_URL || "https://lasyly.com"}/news`,
            ...
            },
            {
              ...
              "position": 5,
              "name": "Sign Up",
              "url": `${process.env.NEXT_PUBLIC_SITE_URL || "https://lasyly.com"}/signup`,
            ...
            },
            {
              ...
              "position": 6,
              "name": "Login",
              "url": `${process.env.NEXT_PUBLIC_SITE_URL || "https://lasyly.com"}/login`,
