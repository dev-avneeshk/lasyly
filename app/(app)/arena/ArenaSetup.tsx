  ...
  return (
    <div className="relative mx-auto flex min-h-full max-w-3xl flex-col gap-8 px-4 py-10 pb-40 md:pb-10">
      ...
      <Section step={3} title="Pick your league">
        ...
        <p className="mt-2 text-center text-[11px] text-[var(--color-text-muted)]">Player prices scale to your league. Bids go up in ${bidIncrementForBudget(budget)} steps.</p>
      </Section>
      ...
      <div className="fixed inset-x-0 bottom-[calc(6rem+env(safe-area-inset-bottom))] z-20 border-t border-[var(--color-border)] bg-[var(--color-background)]/95 px-4 py-3 backdrop-blur-xl md:static md:z-auto md:mt-2 md:border-0 md:bg-transparent md:p-0 md:backdrop-blur-none">
