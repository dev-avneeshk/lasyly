    ...
    <div className="min-h-screen bg-[var(--color-background)] flex items-center justify-center p-4">
      <div className="max-w-md w-full text-center">
        <div className="w-20 h-20 rounded-full bg-[var(--color-lime)]/10 border border-[var(--color-lime)]/20 flex items-center justify-center mx-auto mb-6">
          <Wallet className="w-10 h-10 text-[var(--color-lime)]" />
        </div>
        <h1 className="text-2xl font-bold text-white mb-3">Wallet</h1>
        ...
        <p className="text-[var(--color-text-muted)] text-sm leading-relaxed">
          Manage your funds, top up your balance, and view transaction history. This feature is currently under development.
        </p>
      </div>
    </div>
  )
